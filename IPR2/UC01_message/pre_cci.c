# 1 "c:\\users\\\354\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc01_message\\\\combined_UC01_message.c"
...
# 1 "c:\\users\\\354\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc01_message\\\\combined_UC01_message.c" 2
...
# 2 "c:\\users\\\354\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc01_message\\\\combined_UC01_message.c" 2
...
# 3 "c:\\users\\\354\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc01_message\\\\combined_UC01_message.c" 2
...
# 4 "c:\\users\\\354\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc01_message\\\\combined_UC01_message.c" 2
...
Action()
{
    ...
    messageText = lr_eval_string("{message}");  
    ...
    if (strstr(response, "\"status\":\"success\"") != 0) {
         
        lr_output_message("Request successful.");

         
        if (strstr(response, "\"enrichedMessage\":\"Message enriched and sent to Kafka\"") != 0) {
            lr_output_message("Message was enriched and sent to Kafka.");
            topic = "enriched-messages-topic";  
        } else if (strstr(response, "\"enrichedMessage\":\"Message sent to Kafka without enrichment\"") != 0) {
        ...
        lr_end_transaction("Send_Message", 0);  
    } else {
         
        lr_error_message("Request failed. Response: %s", response);
        lr_end_transaction("Send_Message", 1);  
        topic = 0;  
    }
...
# 5 "c:\\users\\\354\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc01_message\\\\combined_UC01_message.c" 2
...
# 6 "c:\\users\\\354\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc01_message\\\\combined_UC01_message.c" 2
