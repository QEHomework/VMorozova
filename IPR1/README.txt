  ...
  http_kafka_messages_sent_total Количество отправленных сообщений в Kafka

  http://localhost:8080/actuator/prometheus

  Запуск: C:\Users\м\Downloads\prometheus-3.2.1.windows-amd64\prometheus.exe --config.file=prometheus.yml

  7)Grafana localhost:3000 admin/Qwerty123456789

  8)kafka_exporter.exe --kafka.server=127.0.0.1:9092
  http://localhost:9308/metrics

  9)postgres_exporter.exe
